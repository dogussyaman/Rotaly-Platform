          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                size="sm"
                className="h-8 gap-1.5 px-2 rounded-lg text-muted-foreground hover:text-foreground text-xs font-medium"
              >
            ...
            <DropdownMenuContent align="end" className="w-44 rounded-2xl p-1.5 shadow-xl border-border/60">
              <DropdownMenuItem
